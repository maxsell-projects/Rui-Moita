...
@section('meta_description', __('Consultoria imobiliária independente especializada em ativos de investimento e propriedades de luxo.'))
...
@section('content')
    ...
    <section class="relative min-h-screen flex items-center bg-intellectus-base text-white overflow-hidden pt-32 lg:pt-20">
        ...
        <div class="container mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 h-full items-center">
            <div class="lg:col-span-8 lg:col-start-2">
                ...
                <h1 class="font-serif text-5xl lg:text-7xl leading-[1.1] mb-8 font-light text-white">
                    {{ __('Inteligência patrimonial') }} <br>
                    <span class="italic text-gray-500">{{ __('aplicada com rigor.') }}</span>
                </h1>
                ...
                <div class="mt-12 flex flex-col md:flex-row gap-6">
                    <a href="#analise-estrategica" class="group relative px-8 py-4 bg-intellectus-accent text-intellectus-base font-sans text-xs font-bold uppercase tracking-widest hover:bg-white transition-colors duration-500 text-center shadow-lg hover:shadow-intellectus-accent/20">
        ...
        <div class="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-50 animate-bounce">
            <span class="text-[10px] uppercase tracking-widest text-intellectus-accent">{{ __('Scroll') }}</span>
            <div class="w-px h-12 bg-gradient-to-b from-intellectus-accent to-transparent"></div>
        </div>
    </section>

    {{-- 2. POSICIONAMENTO (Editorial) --}}
    <section class="py-24 bg-intellectus-surface text-intellectus-primary">
        <div class="container mx-auto px-6 border-l-2 border-intellectus-primary/10 ml-6 lg:ml-auto max-w-6xl pl-12" data-aos="fade-up">
            <h2 class="font-serif text-3xl lg:text-5xl mb-12">
                {{ __('Mais do que mediação.') }} <br>
                <span class="text-intellectus-muted italic">{{ __('Guardiões de decisões fundamentais.') }}</span>
            </h2>
    ...
    <section class="py-24 bg-white border-t border-gray-100">
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-gray-100">
                ...
                <div class="p-8 group hover:bg-intellectus-surface transition-colors duration-500" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
    ...
    <section class="py-24 bg-intellectus-base text-white relative overflow-hidden">
        <div class="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="order-1 lg:order-2" data-aos="fade-left">
                ...
                <p class="text-xs uppercase tracking-widest text-gray-500 mt-2">Founder & Senior Consultant</p>
            </div>
        </div>
    </section>
    ...
    <section id="atuacao" class="py-24 bg-intellectus-surface">
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-white p-12 hover:shadow-2xl hover:shadow-gray-200/50 transition-all duration-500 border border-gray-100 group" data-aos="fade-up" data-aos-delay="0">
                    ...
                    <a href="{{ route('properties.index') }}" class="text-xs font-bold uppercase tracking-widest text-intellectus-base border-b border-intellectus-base pb-1 hover:text-intellectus-accent hover:border-intellectus-accent transition-colors">{{ __('Ver Portfólio') }}</a>
                </div>

                <div class="bg-white p-12 hover:shadow-2xl hover:shadow-gray-200/50 transition-all duration-500 border border-gray-100 group" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <a href="#analise-estrategica" class="text-xs font-bold uppercase tracking-widest text-intellectus-base border-b border-intellectus-base pb-1 hover:text-intellectus-accent hover:border-intellectus-accent transition-colors">{{ __('Avaliar Imóvel') }}</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-0 bg-intellectus-base text-white">
        <div class="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div class="p-16 lg:p-24 flex flex-col justify-center" data-aos="fade-left">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16">
                ...
                <div class="lg:col-span-4">
                    ...
                    <div class="text-sm text-gray-500 space-y-2 font-mono">
                        <p class="text-intellectus-accent">PRIVATE OFFICE</p>
                        <p class="text-gray-300">{{ __('Lisboa • Porto • Algarve') }}</p>
                        <p class="text-gray-300">+351 963 947 269</p>
