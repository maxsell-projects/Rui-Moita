...
@section('title', 'Termos e Condições | Intellectus')
...
<div class="bg-brand-secondary text-white pt-32 pb-12 text-center">
    <div class="container mx-auto px-6">
        <p class="text-brand-accent font-mono text-xs uppercase tracking-[0.4em] mb-4">Legal & Compliance</p>
    ...
    <div class="container mx-auto px-6 max-w-4xl relative z-10">
        <div class="bg-white p-12 md:p-20 shadow-2xl border-t-8 border-brand-accent relative overflow-hidden">
            ...
            <div class="prose prose-lg max-w-none text-gray-600 font-light leading-relaxed">
                ...
                <p class="text-lg">
                    Bem-vindo ao ecossistema digital da <strong>Intellectus | Rui Moita Private Office</strong>. Ao aceder e utilizar este website, estabelece um compromisso de honra em respeitar os seguintes termos e condições de uso.
                </p>
                ...
                <div class="space-y-10">
                    ...
                    <div>
                        <h3 class="text-xl font-serif text-brand-secondary mb-3 flex items-center gap-3">
                            <span class="text-brand-accent text-sm">01.</span> Identificação e Propriedade
                        </h3>
                        <p class="text-sm text-justify">
                            Este domínio e os seus conteúdos são propriedade exclusiva de <strong>Rui Moita</strong> e da marca <strong>Intellectus</strong>, consultoria imobiliária independente especializada no segmento *High Net Worth*, com escritório profissional situado na Avenida da Liberdade, Lisboa.
                        </p>
                    </div>
                    ...
                    <div>
                        <h3 class="text-xl font-serif text-brand-secondary mb-3 flex items-center gap-3">
                            <span class="text-brand-accent text-sm">02.</span> Propriedade Intelectual
                        </h3>
                        <p class="text-sm text-justify">
                            A curadoria visual, textos, vídeos e identidade gráfica ("Intellectus Private Office") estão protegidos por direitos de autor e propriedade intelectual. A reprodução, cópia ou uso de qualquer material sem autorização expressa e por escrito é estritamente proibida e passível de procedimento judicial.
                        </p>
                    </div>
                    ...
                    <div>
                        <h3 class="text-xl font-serif text-brand-secondary mb-3 flex items-center gap-3">
                            <span class="text-brand-accent text-sm">03.</span> Rigor da Informação
                        </h3>
                        <p class="text-sm text-justify">
                    ...
                    <div>
                        <h3 class="text-xl font-serif text-brand-secondary mb-3 flex items-center gap-3">
                            <span class="text-brand-accent text-sm">04.</span> Limitação de Responsabilidade
                        </h3>
                        <p class="text-sm text-justify">
                    ...
                    <div>
                        <h3 class="text-xl font-serif text-brand-secondary mb-3 flex items-center gap-3">
                            <span class="text-brand-accent text-sm">05.</span> Jurisdição
                        </h3>
                        <p class="text-sm text-justify">
