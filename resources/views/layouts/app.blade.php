...
<head>
    ...
    <title>@yield('title', 'Intellectus | Private Office')</title>
    ...
    <style>
        ...
        /* 1. Ajustes de scrollbar para o Azul da Marca */
        ::-webkit-scrollbar { width: 8px; }
        ::-webkit-scrollbar-track { background: #FDFBF7; }
        ::-webkit-scrollbar-thumb { 
            background: #1B2A41; /* Alterado para o azul brand-primary */
            border-radius: 4px; 
        }
        ::-webkit-scrollbar-thumb:hover { 
            background: #0A0F14; /* Azul mais escuro para o hover */
        }
        ...
        html, body {
            ...
            position: relative;
            /* 2. Cursor personalizado Setasite.png */
            cursor: url("{{ asset('img/Setasite.png') }}"), default;
        }

        /* Garante que elementos clicáveis mantenham o feedback visual adequado */
    ...
    <div x-show="showExitPopup" 
        ...
        <div @click.outside="showExitPopup = false" 
            ...
            <div class="mb-8">
                ...
                <h3 class="text-2xl font-serif text-brand-secondary mb-3">{{ __('Não vá com dúvidas.') }}</h3>
