...
<div x-data="chatbot()" x-init="initBot()" class="fixed bottom-6 right-6 z-50 flex flex-col items-end">
    ...
    <div x-show="open" 
        ...
        <div class="bg-gray-900 p-4 text-white flex justify-between items-center shadow-md">
            ...
            <button @click="open = false" aria-label="Close Chat" class="hover:text-gray-300 transition">
        ...
        <div class="p-3 bg-white border-t border-gray-100">
            <div class="flex items-center gap-2 bg-gray-100 rounded-full px-2 py-2 border border-gray-200 focus-within:border-gray-400 transition">
                ...
                <button @click="toggleRecording()" 
                    ...
                    <svg x-show="!isRecording" x-cloak class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z"></path></svg>
                    <div x-show="isRecording" x-cloak class="w-5 h-5 flex items-center justify-center">
                ...
                <button @click="sendMessage()" :disabled="!userInput.trim() || isLoading" aria-label="Send Message"
    ...
    <button @click="open = !open" 
        ...
        class="bg-gray-900 hover:bg-gray-800 text-white p-4 rounded-full shadow-2xl transition-all hover:scale-110 flex items-center justify-center group relative w-14 h-14">
        <span x-show="!open" x-cloak class="absolute -top-1 -right-1 flex h-3 w-3">
